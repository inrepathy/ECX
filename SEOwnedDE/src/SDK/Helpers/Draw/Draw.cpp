...
void CDraw::Draw3DBox(const Vec3& min, const Vec3& max, const Color_t& clr)
{
	// Get the eight corners of the box
	Vec3 points[8] = {
		{min.x, min.y, min.z},   // Front bottom left
		{max.x, min.y, min.z},   // Front bottom right
		{max.x, max.y, min.z},   // Front top right
		{min.x, max.y, min.z},   // Front top left
		{min.x, min.y, max.z},   // Back bottom left
		{max.x, min.y, max.z},   // Back bottom right
		{max.x, max.y, max.z},   // Back top right
		{min.x, max.y, max.z}    // Back top left
	};
