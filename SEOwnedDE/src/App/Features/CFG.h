...
#pragma region Menu
	...
	CFGVAR(Menu_Accent_Primary, Color_t({ 0, 23,  103, 255 }));
	...
	CFGVAR(UseCustomHealthGradient, false);
	//CustomHealthGradientStart
	CFGVAR(UseCustomHealthColor, false);
	CFGVAR(CustomHealthColor, Color_t({ 0, 20, 20, 255 }));
	CFGVAR(CustomHealthGradientStart, Color_t({ 0, 20, 20, 255 }));
	CFGVAR(CustomHealthGradientEnd, Color_t({ 0, 20, 20, 255 }));
	// LongPath_Color

	CFGVAR(Resolver, false);
	CFGVAR(Resolver_Pitch, false);
	CFGVAR(ResolverClamp, false)
	CFGVAR(Resolver_Yaw, false);
	...
	CFGVAR(AntiAim_FakeAngle, false); 
		CFGVAR(AntiAim_Fake_Yaw, 90.0f);
		CFGVAR(AntiAim_Fake_Pitch, 90.0f);
	CFGVAR(AntiAim_Left, false);
	CFGVAR(AntiAim_Pitch, 90.0f);
	CFGVAR(AntiAim_JitterPitch, false)
	// AntiAim_Yaw
	CFGVAR(AntiAim_Yaw, 90.0f);
